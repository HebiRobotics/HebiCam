...
/**
 * NOTE: Copied from org.bytedeco.javacv.OpenCVFrameGrabber. The only change
 * is that the Mat in grab() gets pre-allocated to avoid a memory leak. /fenner
 *
 * @author Samuel Audet
 * @author Lloyd (github.com/lloydmeta)
 */
public class FixedOpenCVFrameGrabber extends FrameGrabber {
    public static String[] getDeviceDescriptions() throws Exception {
        tryLoad();
        throw new UnsupportedOperationException("Device enumeration not support by OpenCV.");
    }

    public static FixedOpenCVFrameGrabber createDefault(File deviceFile) throws Exception {
        return new FixedOpenCVFrameGrabber(deviceFile);
    }

    public static FixedOpenCVFrameGrabber createDefault(String devicePath) throws Exception {
        return new FixedOpenCVFrameGrabber(devicePath);
    }

    public static FixedOpenCVFrameGrabber createDefault(int deviceNumber) throws Exception {
        return new FixedOpenCVFrameGrabber(deviceNumber);
    }
    ...
    public static void tryLoad() throws Exception {
        if (loadingException != null) {
            ...
            try {
                ...
                throw loadingException = new Exception("Failed to load " + FixedOpenCVFrameGrabber.class, t);
            }
        }
    }

    public FixedOpenCVFrameGrabber(int deviceNumber) {
        this.deviceNumber = deviceNumber;
    }

    public FixedOpenCVFrameGrabber(File file) {
        this(file.getAbsolutePath());
    }

    public FixedOpenCVFrameGrabber(String filename) {
